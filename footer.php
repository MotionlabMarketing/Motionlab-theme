...
<footer class="relative clearfix py3">
    ...
    <div class="container px5 pt3 md-pt6 pb0">
        <div class="px5 col col-12 lg-col-12 text-center md-text-left">
            <div class="mxn5">
    ...
    <div class="container clearfix px5 py3 || white || text-center md-text-left md-flex items-center">
