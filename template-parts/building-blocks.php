...
if( have_rows('building_blocks') ) {
    while ( have_rows('building_blocks') ) {
        ...
        $blocks = ['block_image', 'block_reviews', 'block_gallery', 'block_form', 'block_spacers', 'block_heading', 'block_button', 'block_debug', 'block_team', 'block_cta', 'block_linkBoxes', 'block_videos', 'block_social', 'block_pods', 'block_button', 'block_logos', 'block_tabs', 'block_jobs', 'block_timeline', 'block_utilities'];
