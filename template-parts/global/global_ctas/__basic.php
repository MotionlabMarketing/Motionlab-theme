...
<section <?=get_blockID($block)?> <?=get_blockClasses($block, "")?> <?=get_blockData($block)?>>
    ...
    <div class="flex flex-column md-flex-row">
        ...
        <?php foreach ($block['content']['ctas'] as $cta): ?>
            ...
            <a href="<?=$cta['cta_buttons']['button_link']['url'];?>" class="block col col <?=$block['columns']?> bg-cover bg-center py6 relative hover-reveal" style="background-image:url('<?=$cta['cta_image']['sizes']['galleryMedium'];?>');">
                ...
                <div class="p4 text-center relative z2">
                    ...
                    <h5 class="ls2 white mb3 lh1"><?=$cta['cta_sub_heading'];?></h5>
