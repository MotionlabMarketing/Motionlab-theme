...
<form method="get" class="mb3 flex items-center width-100" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
    ...
    <input type="hidden" name="post_type[]" value="multi_cpt"><!-- restrict results to onlly show products CPT -->
    <button class="btn btn-primary rounded-right" submit name="submit"><i class="fa">&#xf002;</i></button>
    <!-- <input type="submit" class="submit" name="submit" id="searchsubmit" value="<?php esc_attr_e( 'Search Jobs', 'shape' ); ?>"> -->
</form>
