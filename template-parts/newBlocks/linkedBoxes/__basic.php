                          ...
                          <div class="content relative js-match-height py6 flex items-center justify-center text-center <?=($darkenImages == true)? "darken-background" : ""?> <?=($darkenImages == true)? $darkenStrength : ""?>">
                              ...
                              <div class="z-index-40 <?=($block['content']['overlay'] == true)? "opacity-10" : ""; ?>">
                                  ...
                                  <?php if (!empty($item['block_linkBoxes_button']['button_link']['url'])):?>
                                      <p class="inline-block mx-auto mt1 mb0 h5 bold <?=$item['block_linkBoxes_button']['system_text_colours']?> <?=($item['enableButton'] == true)? $item['block_linkBoxes_button']['system_text_colours'] . 'btn btn-medium ' . $item['block_linkBoxes_button']['system_background_colours'] : ''?> <?=$txtColor?>"><?=$item['block_linkBoxes_button']['button_link']['title']?></p>
                                  <?php endif; ?>
