<nav class="pagination clearfix block text-center border-top border-darken-1 py4 mt4 mt5" data-element="pagination">
    <?php $page = $block['posts']->query['paged'] ?: $posts['posts']->query['paged']; ?>

    <?php if($page - 1 > 0) :?> <span aria-current="page" data-page-number="<?=$page-2?>" data-page-type="prev" class="page-numbers page-number cursor-pointer bg-white box-shadow-2">Prev</span> <?php endif;?>
