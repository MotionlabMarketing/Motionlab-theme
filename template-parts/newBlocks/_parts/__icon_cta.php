<?php if($cta['link']): ?>
    <a href="<?= $cta["link"]["url"] ?>" class="flex items-center hover-body hover-zoom cta-icon">
        <div class="bg-darken-2 mr2 border-radius-10 cta-icon-icon" style="width:3rem;">
            <div class="square relative h3 zoom">
                <i class="fa <?= $cta['icon'];?> white absolute top-50 left-50 translate"></i>
            </div>
        </div>
        <div class="">
            <p class="mb0 lh1 brand-primary cta-icon-title"><?= $cta['title'];?></p>
