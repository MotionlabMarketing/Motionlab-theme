...
<!-- pods -->
<section id="<?= $block['custom_id'] ?>" class="relative || <?= $block['custom_css'] ?> <?php echo $bgColor ?> <?php echo $txtColor ?> <?php echo get_sub_field('animate_block') == TRUE ? 'overflow-hidden' : '' ?>">
